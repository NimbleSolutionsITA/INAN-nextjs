...
export const API_GET_PRODUCTS_ENDPOINT = `/api/products`
export const API_CUSTOMER_ENDPOINT = `/api/customer`
export const API_ORDER_ENDPOINT = `/api/orders`
export const API_SALES_ENDPOINT = `/api/private-sales`
export const WORDPRESS_VERIFY_TOKEN_ENDPOINT = `${WORDPRESS_API_ENDPOINT}/jwt-auth/v1/token/validate`
